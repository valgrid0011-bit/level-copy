  ...
  return (
    <div className="min-h-screen bg-gray-50 flex-1">
      ...
      <div className="bg-white border-b border-gray-200 px-6">
        <div className="max-w-lg md:max-w-full flex gap-6 overflow-x-auto">
          {tabs.map((tab) => (
            <button
              key={tab}
              onClick={() => setActiveTab(tab)}
              className={`px-1 py-3 text-sm font-medium border-b-2 transition-colors whitespace-nowrap ${activeTab === tab
        ...
        {activeTab === 'System' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
            <div className="space-y-6">
              {/* Operating System */}
              <div className="bg-white border text-sm border-gray-200 rounded-lg p-5 shadow-sm">
                <div className="flex items-center gap-2 mb-4">
